...
db.TotalReservationsCouvertsParJour = require('./TotalReservationsCouvertsParJour.model')(sequelize, Sequelize.DataTypes);
db.ReservationsTablesParCreneauJour = require('./ReservationsTablesParCreneauJour.model')(sequelize, Sequelize.DataTypes);
db.MaxCommandesParJoursEtMinutes = require('./MaxCommandesParJoursEtMinutes.model')(sequelize, Sequelize.DataTypes);
...
db.Livraison = require('./Livraison.model')(sequelize, Sequelize.DataTypes);
