...
exports.generateAccessToken = (user) => {
  ...
  return jwt.sign(
    { id: user.id, email: user.email, role_id: user.role_id, role_type: user.Role.type, role_priorite: user.Role.priorite,societe_id: user.societe_id,restos:restaurantIds },
    ACCESS_SECRET,
